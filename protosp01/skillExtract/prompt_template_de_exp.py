...
job_inst_extr_skills = (
    "You are an expert human resource manager. You are given an extract from a job description in German. Highlight all the skills, competencies and tasks that are required from the candidate applying for the job, by surrounding them with tags '@@' and '##'."
    "Make sure you don't highlight job titles, nor elements related to the company and not to the job itself."
)

job_shots_extr_skills = [
    "Sentence: Wir suchen einen Teamleiter mit ausgeprägten Kommunikationsfähigkeiten, der die Zusammenarbeit und den Informationsaustausch im Team fördert. \nAnswer: Wir suchen einen Teamleiter mit ausgeprägten @@Kommunikationsfähigkeiten##, der die Zusammenarbeit und den Informationsaustausch im Team fördert.",
    "Sentence: Sie benötigen gute Kenntnisse in den Programmiersprachen Python und C++. Vertrautheit mit Rust und Go sind ein Plus. \nAnswer: Sie benötigen gute Kenntnisse in den Programmiersprachen @@Python## und @@C++##. Vertrautheit mit @@Rust## und @@Go## sind ein Plus.",
    "Sentence: Sie werden für die Entwicklung des neuen Produkts des Unternehmens verantwortlich sein. \nAnswer: Sie werden für die Entwicklung des neuen Produkts des Unternehmens verantwortlich sein.",
    "Sentence: Die Fähigkeit, interdisziplinär zusammenzuarbeiten, ist ein wichtiges Kriterium für diese Position. \nAnswer: Die @@Fähigkeit, interdisziplinär zusammenzuarbeiten##, ist ein wichtiges Kriterium für diese Position.",
    "Sentence: Sie haben sehr gute Kenntnisse in der digitalen Schaltungstechnik und in Regelkreisen. \nAnswer: Sie haben sehr gute Kenntnisse in der @@digitalen Schaltungstechnik## und in @@Regelkreisen##.",
    "Sentence: Neben Kenntnissen über moderne, agile Softwareentwicklung und deren Konzepte verfügen Sie auch über Grundkenntnisse in der Testautomatisierung. \nAnswer: Neben Kenntnissen über moderne, @@agile Softwareentwicklung## und deren Konzepte verfügen Sie auch über Grundkenntnisse in der @@Testautomatisierung##.",
]

job_inst_extr_wlevels = (
    "You are given sentences from a job description in German. Extract skills and competencies (as exact substrings of the sentence) that are explicitly required from the candidate applying for the job. "
...
job_shots_extr_wlevels = [
    'Sentence: Wir suchen einen Teamleiter mit ausgeprägten Kommunikationsfähigkeiten, der die Zusammenarbeit und den Informationsaustausch im Team fördert. \nAnswer: {"Kommunikationsfähigkeiten": "expert"}',
    'Sentence: Sie benötigen gute Kenntnisse in den Programmiersprachen Python und C++. Vertrautheit mit Rust und Go sind ein Plus. \nAnswer: {"Python": "expert", "C++": "expert", "Rust": "beginner", "Go": "beginner"}',
    "Sentence: Sie werden für die Entwicklung des neuen Produkts des Unternehmens verantwortlich sein. \nAnswer: {}",
...
job_shots_extr_wreqs = [
    'Sentence: Wir suchen einen Teamleiter mit ausgeprägten Kommunikationsfähigkeiten, der die Zusammenarbeit und den Informationsaustausch im Team fördert. \nAnswer: {"Kommunikationsfähigkeiten": ["expert", "required"]}',
...
course_inst_extr_skills = "You are given a sentence from a course description in German. Highlight all the skills and competencies that are learned when following the course described in the sentence, by surrounding them with tags '@@' and '##'."

course_shots_extr_skills = [
    "Sentence: Dieser Kurs ist von Grund auf, daher sind keine Vorkenntnisse erforderlich, aber wenn ein Student grundlegende Kenntnisse in HTML, CSS und JS hat, dann wird es vorteilhaft sein. Internetzugang erforderlich\nAnswer: Dieser Kurs ist von Grund auf, daher sind keine Vorkenntnisse erforderlich, aber wenn ein Student grundlegende Kenntnisse in HTML, CSS und JS hat, dann wird es vorteilhaft sein. Internetzugang erforderlich",
    "Sentence: Strategisches IT-GRC: IT-Governance, IT-Risiko- und Compliance-Management als Bindeglied zwischen Business und IT.\nAnswer: Strategisches IT-GRC: @@IT-Governance, IT-Risiko- und Compliance-Management## als Bindeglied zwischen Business und IT.",
    "Sentence: Wir bringen Ihnen alles bei, was Sie wissen müssen, um Ihre AWS-Kenntnisse zu verbessern. Nicht für Zertifizierungsprüfungen und diejenigen ohne Erfahrung\nAnswer: Wir bringen Ihnen alles bei, was Sie wissen müssen, um Ihre @@AWS-Kenntnisse## zu verbessern. Nicht für Zertifizierungsprüfungen und diejenigen ohne Erfahrung",
    "Sentence: Was denken Sie über das Spring Framework? Warum ist Spring beliebt? Können Sie ein Gesamtbild des Spring Frameworks geben? \nAnswer: Was denken Sie über das @@Spring Framework##? Warum ist Spring beliebt? Können Sie ein Gesamtbild des Spring Frameworks geben?",
    "Sentence: Programmieren in C#. Erstellen Sie originale Spielgrafiken in Blender. Texturieren Sie 3D-Modelle in Photoshop.\nAnswer: Programmieren in @@C###. Erstellen Sie originale Spielgrafiken in @@Blender##. Texturieren Sie 3D-Modelle in @@Photoshop##.",
    "Sentence: Erstellen Sie Web-Apps in der ELM-Sprache und 2D-Spiele! Der komplette Leitfaden für beginner für Webprogrammierer und Spieleentwickler\nAnswer: Erstellen Sie @@Web-Apps in der ELM-Sprache## und @@2D-Spiele##! Der komplette Leitfaden für beginner für Webprogrammierer und Spieleentwickler",
]

course_inst_extr_wlevels = (
    "You are given sentences from a German course description. Extract explicit skills and competencies (as substrings of the sentence) that the course will either teach you or are mandatory prerequisites for the course. "
    # "You are given sentences from a German course description. Extract skills and competencies (as substrings of the sentence) that the course will explicitly teach you."
    # "You are given sentences from a German course description. Extract explicit skills and competencies (as substrings of the sentence) that are mandatory prerequisites for the course. "
    "Infer the corresponding skill mastery level ('beginner', 'intermediate', 'expert', or 'unknown') of each skill based on the context. "
    "Return the output as only a json file extracted substrings (as keys) and their inferred mastery levels (as values).\n"
)
...
PROMPT_TEMPLATES = {
    ...
    "course": {
        ...
        "extraction": {
            "skills": {
                "instruction": course_inst_extr_skills,
